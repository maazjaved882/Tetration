...
def get_conversations():
    ...
    req_payload = {
                    "version": version_num,
                     "filter": {"type":"eq","field":"consumer_filter_id","value":"5eb1a9ef497d4f0f2a04f685"},
                     "limit" : 5000,
                     "offset": ''
                   }
    ...
    if conversations_results.status_code == 200:
        ...
        print (conversations_results.content)   
...
if __name__ == '__main__':
    ...
    conv_df.to_csv('{}.csv'.format(application_name.split(':')[len(application_name.split(':'))-1].replace(' ','_'), index=False))
